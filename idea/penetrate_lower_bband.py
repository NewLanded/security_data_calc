        ...
        for ts_code in ts_codes:
            try:
                ...
                if buy_flag is True:
                    ...
                    result_now = pd.DataFrame([security_point_data.iloc[0], security_point_data.iloc[1], security_point_data.iloc[2], security_point_data.iloc[5], security_point_data.iloc[10]], index=[['next_0_day', 'next_1_day', 'next_2_day', 'next_5_day', 'next_10_day'], [1, 1, 1, 1, 1]])
